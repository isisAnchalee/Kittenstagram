...
ActiveRecord::Schema.define(version: 20141126214100) do
  ...
  add_index "followees_followers", ["follower_id", "followee_id"], name: "index_followees_followers_on_follower_id_and_followee_id", using: :btree
